...
top_restaurants = collection.aggregate(pipeline)
...
def plot_cuisine_pie_chart(filtered_cuisines):
    ...
    patches, texts, autotexts = plt.pie(sizes, explode=explode, labels=labels, autopct='%1.1f%%', startangle=140,textprops=dict(color="black",fontsize=10))  # Set font color and size for percentages
